...
A collection of browser bookmarklets for open-source intelligence gathering. 
## Installation

### Drag from the web page

Visit [bookmarklets.notalex.sh](https://bookmarklets.notalex.sh) and drag any link to your bookmarks bar.
...
Pre-minified `javascript:` URIs are in [`dist/bookmarklets/`](https://github.com/notalex-sh/osint-bookmarklets/tree/main/dist/bookmarklets). Create a new bookmark and paste the contents as the URL.

### Convert yourself

The un-minified source files are in `bookmarklets/`. Convert them to bookmarklets at [cybermark.notalex.sh](https://cybermark.notalex.sh).
