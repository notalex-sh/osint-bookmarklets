(function() {
  ...
  titleEl.textContent = 'WAYBACK MACHINE';
  ...
  pageRow.style.cssText = 'padding:8px 0;border-bottom:1px solid #222;word-break:break-all';
  var lbl = document.createElement('span');
  lbl.textContent = 'Page';
  lbl.style.cssText = 'color:#777';
  var val = document.createElement('span');
  val.textContent = '  ' + window.location.href;
  val.style.cssText = 'color:#fff;font-weight:700';
  pageRow.appendChild(lbl);
  pageRow.appendChild(val);
  ...
  openBtn.textContent = 'Open Wayback Machine';
